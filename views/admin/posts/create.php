...
<head>
    ...
    <title><?= isset($post) ? 'Sửa bài viết' : 'Thêm bài viết mới' ?></title>
...
<div class="main-content">
    ...
    <div class="form-container">
        <h1><?= isset($post) ? 'Sửa bài viết' : 'Thêm bài viết mới' ?></h1>

        <form action="index.php?action=<?= isset($post) ? 'update&id=' . $post['id'] : 'store' ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="content" name="content" required placeholder="Nhập nội dung bài viết..."><?= isset($post) ? $post['content'] : '' ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="category_id" name="category_id" required>
                    ...
                    <?php foreach($categories as $cat): ?>
                        <option value="<?= $cat['id'] ?>" <?= (isset($post) && $post['category_id'] == $cat['id']) ? 'selected' : '' ?>>
            ...
            <div class="form-group">
                ...
                <?php if(isset($post) && $post['image']): ?>
                    <div class="image-preview">
                        <img src="/studentdiary/public/uploads/<?= $post['image'] ?>" alt="Preview" style="max-width: 200px; margin-top: 10px;">
                    </div>
                <?php else: ?>
            ...
            <div class="form-group">
                ...
                <select id="status" name="status">
                    <option value="published" <?= (isset($post) && $post['status'] == 'published') ? 'selected' : '' ?>>Đã đăng</option>
                    <option value="draft" <?= (isset($post) && $post['status'] == 'draft') ? 'selected' : '' ?>>Nháp</option>
                </select>
            </div>
