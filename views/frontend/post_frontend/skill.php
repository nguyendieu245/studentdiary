...
<div class="container">
    <div class="intro-box">
        <p class="intro-text">
            Kỹ năng là chìa khóa giúp bạn phát triển bản thân và thành công trong học tập cũng như công việc. 
            Tại đây, mình sẽ chia sẻ những bài viết bổ ích giúp bạn nâng cao kỹ năng mềm, quản lý thời gian và giao tiếp hiệu quả trong cuộc sống đại học.
        </p>
    </div>
